...
.dossier-card {
  ...
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5), 0 0 10px rgba(0, 188, 212, 0.1);
...
.avatar {
  width: 50px; height: 50px; background: #1c2128; border-radius: 50%;
  display: flex; align-items: center; justify-content: center; border: 2px solid #333; color: #555;
}
.identity .name { margin: 0; font-size: 1.4rem; font-weight: 800; letter-spacing: 1px; color: #fff; }
.identity .alias { font-size: 0.75rem; color: #00bcd4; font-family: monospace; letter-spacing: 2px; }

.risk-badge {
  text-align: right; border: 2px solid #333; padding: 4px 12px; border-radius: 6px;
...
.risk-val { font-size: 1.4rem; font-weight: 900; line-height: 1; }

/* Body */
.card-body { display: flex; padding: 25px; gap: 30px; min-height: 300px; flex-wrap: wrap; }
.col-visual { flex: 1; display: flex; flex-direction: column; min-width: 300px; }
.col-intel { flex: 1.2; min-width: 300px; }
...
/* Footer */
.card-footer {
  background: #161b22; padding: 12px 25px; border-top: 1px solid #222;
  display: flex; justify-content: space-between; align-items: center;
}
.ai-verdict { font-size: 0.85rem; }
...
.stamp-verified {
  ...
  transform: rotate(-5deg); font-size: 0.7rem; letter-spacing: 2px; opacity: 0.8;
}
</style>